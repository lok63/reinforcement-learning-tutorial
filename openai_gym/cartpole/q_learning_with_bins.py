...
class FeatureTransformer:
  def __init__(self):
    ...
    self.cart_velocity_bins = np.linspace(-2, 2, 10) # (-inf, inf) (I did not check that these were good values)
    self.pole_angle_bins = np.linspace(-0.4, 0.4, 10)
    self.pole_velocity_bins = np.linspace(-3.5, 3.5, 10) # (-inf, inf) (I did not check that these were good values)
